...
class GraphTreeNode   {
 public:
  ...
  void setString(int pos, char *s, long long f);
  void addString(int pos, char *s, long long f);
  void showFrequency(int pos, char *s);

  void populateGTrie(GTrie *gt, int size, int pos, char *s);
  void populateMap(mapStringLL *m, int size, int pos, char *s);
...
class GraphTree   {
 ...
 public:
  ...
  void setString(char *s, long long f);
  void addString(char *s, long long f);
  ...
  void populateMap(mapStringLL *m, int maxsize);
