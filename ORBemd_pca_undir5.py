...
def KSAQ(indir,outdir,n):
    ...
    for i,K in enumerate(c):
        ...
        if i==0:
            ...
            Ms=Ms+K
        if i==3:
            cy.toM(Ms/(i+1),queries,'NetEmd_G3_5W_{}_PCA{}EXPVAR'.format(indir,expvar))
        elif i==14:
            cy.toM(Ms/(i+1),queries,'NetEmd_G4_5W_{}_PCA{}EXPVAR'.format(indir,expvar))
        elif i==72:
            cy.toM(Ms/(i+1),queries,'NetEmd_G5_{}_PCA{}EXPVAR'.format(indir,expvar))
